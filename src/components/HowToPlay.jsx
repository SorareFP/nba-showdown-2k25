    ...
    <div className={s.wrap}>
      ...
      <div className={s.rules}>
        ...
        <AccordionSection {...sec('cards')}>
          ...
          <p><strong>Coach difficulty</strong> runs Settler to Deity. <strong>Prince is a fair game</strong> &mdash; the coach plays its full search against an even roster &mdash; and pays the standard rate. Below it the coach is worse at its job and a game pays less. Above it the coach is never made smarter than fair and <em>your</em> players are never made worse: its <strong>team</strong> is better, drawn to a richer cap you can see on its cards, and it weighs more of your possible lineups before it places. King pays 125%, Deity 150%. A season or dynasty remembers the rung it was built at: you can turn the coach down any time, but a game in it never pays above that rung. Two people in PvP play on their own logic, and a PvP game pays the <strong>top rate</strong> &mdash; the same as Deity &mdash; because a person is the best opponent there is.</p>
          <h4>Card Phases</h4>
          <ul>
        ...
        <AccordionSection {...sec('collection')}>
          ...
          <ul>
            <li>Playing earns <strong>coins</strong>: every finished game, a win bonus that grows with the margin (20 for a one-point win up to 100 for a 50-point blowout; PvP pays half again), 15 for losing by five or fewer, milestones by your own players (a triple-double, a 50-point game) and a daily first-win bonus. Coins buy packs, from the 100-coin Booster up to the 6,000-coin Legendary Chase. Special sets — Super Season, Rookie, Summer Standouts and their WNBA counterparts — appear in ordinary packs at reduced odds.</li>
          ...
          <ul>
            ...
            <li><strong>Dynasty</strong>: ten seasons in one league, paying players in <strong>Dynasty Points</strong>. Every team fits a <strong>100-DP cap</strong>; re-signing your own players and signing your draft picks may take you past it, up to your <strong>130-DP apron</strong>. Bring your own team and it arrives on real contracts, over the apron if it must — then you shed salary to get under it before you can re-sign anyone. AI teams arrive <strong>under the cap</strong> and may re-sign up to <strong>115</strong>, both scaled up by the league's coach rung. A trade holds each side to its own apron, and a side over the cap afterwards takes back at most 125% of the DP it sends out. Each offseason a <strong>draft class</strong> of two players a team plus four is drawn from the pool a year ahead, by rarity — one rare guaranteed, a super-rare more often than not, a legendary about one year in seven — and two rounds are drafted. A pick signs on the <strong>rookie scale, priced by the slot</strong>: 10 DP at the first pick down to 5 at the end of round one, 3 down to 2 in round two, three years. A drafted player is your <strong>rights until the season starts</strong> — sign him at the scale any time before, up to the apron; unsigned at tip-off, he becomes a free agent. AI teams draft only what their books can sign and keep room for their picks when they re-sign; a team short of eight players may sign its pick past its apron rather than a free agent past it.</li>
          </ul>
