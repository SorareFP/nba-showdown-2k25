...
describe('FreeAgentsPanel', () => {
  it('renders the search, the three-request limit, and loading states before anything arrives', () => {
    ...
    expect(out).toContain('NBA regular seasons from 1984-85 to 2025-26 (plus 1975-76 and 1976-77), playoff runs from 2002 to 2026, and WNBA seasons from 1997 to 2026');
