...
describe('prizes', () => {
  ...
  it('season money scales with length and takes the dynasty factor', () => {
    ...
    // A fantasy-draft dynasty pays HALF — the user's correction, 2026-09-11 ("I meant nerf").
    expect(seasonEarnings('regular', { champion: true }, dynastyCoinFactor('fantasy-full'))).toEqual({ coins: 200, label: 'Season Champion' });
    expect(dynastyCoinFactor('fantasy-random')).toBe(0.5);
