...
export const STRATS = [
  ...
  { id:'full_court_press',    name:'Full-Court Press',   phase:'matchup',  side:'def', copies:2, locked:false, color:'#334155', rarity:'uncommon',
    desc:'Set the press: every opposing player with Speed 8 or less gets −1 to their scoring roll this segment.' },
  ...
  { id:'you_stand_over_there',name:'You Stand Over There',phase:'pre_roll',side:'off', copies:2, locked:false, color:'#7C3AED', rarity:'rare',
  ...
  { id:'pin_down_screen',     name:'Pin-Down Screen',    phase:'pre_roll', side:'off', copies:2, locked:false, color:'#BE185D', rarity:'rare',
  ...
  // ── SCORING PHASE ──
  { id:'green_light',         name:'Green Light',        phase:'scoring',  side:'off', copies:2, locked:false, color:'#16A34A', rarity:'rare',
    desc:'Select one player to attempt three 3PT Shot Checks instead of their scoring roll.' },
  { id:'from_way_downtown',   name:'From Way Downtown',  phase:'scoring',  side:'off', copies:3, locked:false, color:'#2563EB', rarity:'uncommon',
    desc:'3PT Shot Check at +1. Roll 1–3: cold marker. Roll 18–20: hot marker.' },
  { id:'catch_and_shoot',     name:'Catch & Shoot',      phase:'scoring',  side:'off', copies:3, locked:false, color:'#0891B2', rarity:'uncommon',
    desc:'Player with Speed 12+ attempts a 3PT Shot Check at +2. Success: +1 assist.' },
  { id:'elevator_doors',      name:'Elevator Doors',     phase:'scoring',  side:'off', copies:2, locked:false, color:'#EA580C', rarity:'rare',
    desc:'Choose a player with a 3PT Bonus. They attempt a 3PT Shot Check at an additional +3.' },
  { id:'bully_ball',          name:'Bully Ball',         phase:'scoring',  side:'off', copies:3, locked:false, color:'#DC2626', rarity:'uncommon',
    desc:'Player with a Power advantage attempts two Paint Shot Checks. Power advantage ≥4: +2 to each check.' },
  { id:'power_move',          name:'Power Move',         phase:'scoring',  side:'off', copies:3, locked:false, color:'#9333EA', rarity:'uncommon',
    desc:'Choose a player: +2 Power. If their Power advantage is already ≥5: +3 Power instead.' },
  { id:'and_one',             name:'And One!!!',         phase:'scoring',  side:'off', copies:3, locked:true,  color:'#F59E0B', rarity:'rare',
  ...
  { id:'cross_court_dime',    name:'Cross-Court Dime',   phase:'scoring',  side:'off', copies:2, locked:false, color:'#7C3AED', rarity:'rare',
  ...
  { id:'double_team',         name:'Double Team',        phase:'scoring',  side:'def', copies:2, locked:false, color:'#1E40AF', rarity:'uncommon',
    desc:'Send two at the ball: choose an opposing player who hasn\'t rolled — their defender gets +6 Speed/+6 Power this segment. But someone is open: choose another opposing player who hasn\'t rolled to gain +2 to their scoring roll.' },
  ...
  { id:'this_is_my_house',    name:'This Is My House!',  phase:'scoring',  side:'def', copies:2, locked:true,  color:'#991B1B', rarity:'rare',
  ...
  // ── POST-ROLL ──
  { id:'heat_check',          name:'Heat Check',         phase:'post_roll',side:'off', copies:3, locked:true,  color:'#F97316', rarity:'rare',
  ...
  { id:'cold_spell',          name:'Cold Spell',         phase:'reaction', side:'def', copies:3, locked:false, color:'#0284C7', rarity:'uncommon',
    desc:'Opponent rolls a natural 1 or 2 on their scoring roll: apply a cold marker + reduce their Rebound Track by 1.' },
  { id:'anticipate_pass',     name:'Anticipate the Pass',phase:'reaction', side:'def', copies:2, locked:false, color:'#0F766E', rarity:'uncommon',
  ...
  { id:'fast_break',          name:'Fast Break',         phase:'reaction', side:'off', copies:2, locked:false, color:'#0D9488', rarity:'common',
    desc:'An opposing player scored 0 on their scoring roll this segment: a player with Speed 12+ who hasn\'t rolled gets +2 to their scoring roll.' },
