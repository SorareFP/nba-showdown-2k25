    ...
    <div className={s.wrap}>
      ...
      <div className={s.rules}>
        ...
        <AccordionSection {...sec('crunch')}>
          ...
          <ul>
            <li><strong>The timeout search.</strong> Crunch-only cards stay in the deck until you draw them — or until you call your timeout, when you may take <strong>one</strong> crunch-only card from your deck into hand and shuffle the rest.</li>
