    ...
    <div className={s.rulebook}>
      ...
      <Section id="collection">
        ...
        <ul>
          ...
          <li><strong>Aging dynasty:</strong> no tenth-year finish; it runs until it is ended between seasons. Every player is a year older at each turn of the year, and anyone in the league aged 35 or more rolls to retire: (age − 34) in 6, so certain at 40 (Sports Science shifts a coach's players later, and Prime Extension skips one player's roll). A retiring player's contract or rights end with him, with no dead money, and he never returns. <strong>Retirements are the first step of the offseason</strong>, ahead of the re-signing window: the league has already rolled, re-signed its AI teams and posted its offers, and the step shows who went (the coach's own first, with the deal that went with them) and which of the coach's players face the roll at the next turn. With friends, every coach readies past it. Age never changes a card; asks fall past 31.</li>
