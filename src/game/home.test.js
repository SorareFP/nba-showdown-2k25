...
describe('news', () => {
  ...
  it('carries Unethical Hoops, and every button goes somewhere the app knows', () => {
    ...
    const places = ['play', 'season', 'dynasty', 'shop', 'goals', 'collection', 'howtoplay', 'builder', 'freeagents'];
...
describe('closest collections', () => {
  ...
  it('names the pack that feeds a goal, and none for a set no pack sells', () => {
    ...
    expect(packForGoal(GOALS_BY_ID['set-super-season'])).toMatchObject({ id: 'super_season', price: 450 });
