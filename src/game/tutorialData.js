...
export const TUTORIAL_TOOLTIPS = [
  ...
  },
  {
    ...
    detail: "1 AST = +1 to a shot check. 5 AST = a 3PT check or a Paint check for any player — their bonus rides on the die, and the button shows the roll he needs. The first time you reach 5 assists you draw a bonus card!",
    section: 2,
    priority: 70,
