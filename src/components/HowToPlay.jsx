    ...
    <div className={s.wrap}>
      ...
      <div className={s.rules}>
        ...
        <AccordionSection {...sec('cards')}>
          ...
          <p><strong>A card that replaces a roll</strong> &mdash; Green Light, You Stand Over There, Five-Out Offense, Cross-Court Dime &mdash; is worth its shot checks <em>minus the roll it gives up</em>. Your best scorer is usually the <em>worst</em> player to spend it on: a star's roll pays in points, rebounds and assists that two checks rarely match. Below Prince, and always in the tutorial, the picker shows that number beside each player. The coach reads the same one.</p>
          <p><strong>Coach difficulty</strong> runs Settler to Deity. <strong>Prince is a fair game</strong> &mdash; the coach plays its full search against an even roster &mdash; and pays the standard rate. Below it the coach is worse at its job and a game pays less. Above it the coach is never made smarter than fair and <em>your</em> players are never made worse: its <strong>team</strong> is better, drawn to a richer cap you can see on its cards, and it weighs more of your possible lineups before it places. A <strong>win</strong> at King pays 125%, at Deity 150%; a <strong>loss pays the standard rate</strong> at every rung from Prince up (below Prince the cut applies win or lose). The premium is for beating a team the coach <strong>drew itself</strong>: a game where you built the coach's team (Team Builder Rosters), picked the coach's deck, or played a Quick Match pays at most the standard rate. A game keeps the difficulty it was dealt at — changing the setting moves the next game, not this one. A season remembers the rung it was built at: you can turn the coach down any time, but a game in it never pays above that rung. A dynasty is played at its own rung: every game in it is coached and paid at the rung the league was built at, whatever this setting says. Two people in PvP play on their own logic, and a PvP game pays the <strong>top rate</strong> &mdash; the same as Deity &mdash; because a person is the best opponent there is.</p>
          <h4>Card Phases</h4>
          <ul>
        ...
        <AccordionSection {...sec('crunch')}>
          ...
          <ul>
            ...
            <li><strong>The Timeout:</strong> one per team per game, and one more in each overtime, Crunch Time only, called once <strong>the other team has rolled</strong> in the section (your own roll does not open it). It pauses play, lets you fully re-set your defensive matchups, lets you search the deck for one crunch-only card, and opens the window for the <strong>timeout riders</strong>: ATO Masterpiece (a chosen player takes a check at +2 out of the huddle), Fresh Legs (two players shed 4 minutes), Ice the Hot Hand (strip an opponent's hot markers), Reset (clear your own cold markers).</li>
        ...
        <AccordionSection {...sec('collection')}>
          ...
          <ul>
            ...
            <li><strong>Season</strong>: a round-robin schedule against the league — Short (everyone once), Regular (home and away) or Long — with standings, playoffs and a title purse, paid by the <strong>share of your own games you played</strong> — a game you sim counts against it. Player stats keep every game, and when the regular season ends the league names its MVP, Defensive Player of the Year, Sixth Player, Rookie of the Year and scoring champion.</li>
            <li><strong>Dynasty</strong>: ten seasons in one league, paying players in <strong>Dynasty Points</strong>. Every team fits a <strong>100-DP cap</strong>; re-signing your own players, signing your draft picks and claiming a player off waivers may take you past it, up to your <strong>130-DP apron</strong>. Bring your own team and it arrives on real contracts, over the apron if it must — then you shed salary to get under it before you can re-sign anyone. AI teams arrive <strong>under the cap</strong> and may re-sign up to <strong>115</strong>, both scaled up by the league's coach rung. AI teams must <strong>also</strong> keep their roster's <strong>card salary under $5,500 × the rung</strong> (the Team Builder cap: $5,500 up to Prince, $5,775 at King, $6,160 at Deity) through every draft pick, signing, re-signing, waiver claim and trade, keeping room as it goes for the cards its coming picks will carry and about $150 for each seat it is still short of eight — an AI team already over it adds no salary until it is back under; nobody is cut. The one way past it is the floor: a team short of eight with no room left fills the seat with the cheapest card there is. Your team answers to DP alone. A dynasty game's coach plays at the league's rung, not this device's difficulty — the Coach picker beside Play does not reach a dynasty game. A trade holds each side to its own apron — an AI team already past it only trades down — and a side over the cap afterwards takes back at most 125% of the DP it sends out. Each offseason a <strong>draft class</strong> of two players a team plus four is drawn from the pool a year ahead, by rarity — one rare guaranteed, a super-rare more often than not and two in about 15% of classes, a legendary about one year in seven — and two rounds are drafted. A pick signs on the <strong>rookie scale, priced by the slot</strong>: 10 DP at the first pick down to 5 at the end of round one, 3 down to 2 in round two, three years. A drafted player is your <strong>rights until the season starts</strong> — sign him at the scale any time before, up to the apron; unsigned at tip-off, he becomes a free agent. AI teams draft only what their books can sign and keep room for their picks when they re-sign; a team short of eight players may sign its pick past its apron rather than a free agent past it. A player you <strong>waive</strong> goes <strong>on waivers</strong> until the league next moves on (the next phase, week of free agency or round): the teams are asked worst record first, and the first to claim him takes his contract — and <strong>his DP comes off your books</strong>. Unclaimed, he is a free agent and his DP stays on your cap that season as dead money. Claim someone else's from the waiver wire in your front office, if he fits under your apron with a roster spot. <strong>Trades:</strong> a side that would end with more than ten players <strong>waives its weakest to make room</strong> — one man at most, onto waivers, his DP on that side's books this season unless he is claimed — and the AI takes a deal like that only if it still wins without him. AI teams trade among themselves (up to three deals an offseason, only when both sides come out ahead) and <strong>make you offers</strong>: each turn of the offseason and each round up to the trade deadline, one a team at most, never below 90% of what they ask you to give by your own team's needs. An offer waits under Trade offers until the next turn and is checked again when you accept it — one the league has moved past says why and cannot be taken. With friends, a trade between coaches is an offer the other coach answers, the commissioner can veto it until the next phase (never a trade with an AI team), and a coach can have ten offers waiting at once.</li>
            <li><strong>Players age</strong> (an aging dynasty, which runs until you end it): everyone is a year older each offseason, and from 35 a player may retire at the turn of the year — one in six at 35, more each year, certain at 40. His contract ends with him, with no dead money. The offseason <strong>opens on the retirements</strong>: who went, yours first with the deal that went with them, and which of your players face the roll next year. Nobody gets better or worse with age; asks fall past 31.</li>
            <li><strong>Staff</strong>: Franchise Points also hire a front office, three tiers a role, kept for the dynasty — a <strong>Head Scout</strong> (a graded class and the AI's mock board, +25% lottery weight, a steal after the last pick), a <strong>Cap Strategist</strong> (every free agent's personality and floor shown, your own players re-sign 10% under their ask, a 125-DP apron) and, in an aging dynasty, <strong>Sports Science</strong> (retirement risk starts later, one protected player a year, the whole window two years later). Tiers cost 3, 6 and 12.</li>
            <li><strong>Franchise Points</strong>: a currency of the dynasty itself, paid to every coach as a year closes — your regular-season finish (first of the league is 10, last is 0), 3 for each playoff series you win, 10 for the title, all weighted by the coach rung. Spend them in the offseason to <strong>bring a card you own into the league</strong>: a common for 2, an uncommon 4, a rare 8, a super-rare 16, a legendary 32; the player signs at his value for two years under the cap, and the card stays in your collection. Your <strong>strategy deck is never frozen</strong>: change it in the Front Office or between rounds, alone or with friends.</li>
          </ul>
        ...
        <AccordionSection {...sec('glossary')}>
          <dl className={s.glossary}>
            ...
            <dt>Timeout</dt><dd>One per game, Crunch Time only, once the other team has rolled in the section: re-set the defence and play a rider.</dd>
